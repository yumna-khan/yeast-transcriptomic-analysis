...
## Discussion
The PCA analysis ([Figure 1](results/PCA.jpeg)) shows clear separation between Early, Thin, and Mature biofilm stages, confirming that each stage represents a distinct transcriptional state. The strong separation suggests that biofilm development is driven by major shifts in gene expression. Importantly, both PCA and volcano plot analyses suggest that the Thin stage does not simply sit between Early and Mature as a gradual transition. Instead, it appears to act as a key intermediate phase where a biofilm-specific program is first established and later refined. This indicates that velum development is a structured, stepwise process rather than a simple linear progression.

The Thin vs Early comparison identified 839 differentially expressed genes (419 upregulated and 420 downregulated). The nearly equal balance of activation and repression suggests coordinated reprogramming rather than random change. The volcano plot ([Figure 5](results/volcano_tve.jpeg)) shows extremely strong statistical support for many of these genes (−log₁₀ adjusted p-values exceeding 100), indicating strong confidence in these transitions. Early biofilm formation therefore requires both repression of growth-related pathways and activation of genes involved in adhesion and structure, including members of the FLO family, which encode hydrophobic cell wall proteins required for buoyancy and surface attachment [^16]. Previous studies in flor yeast have similarly shown that velum initiation involves rapid changes in cell surface composition and metabolism [^16][^18].

The most extensive transcriptional divergence occurs in the Mature vs Early comparison, with 1,883 DEGs (1,043 upregulated, 840 downregulated). Many genes display large effect sizes (|log₂FC| > 5), corresponding to ≥32-fold expression changes, and extremely high statistical significance ([Figure 6](results/volcano_mve.jpeg)). While this does not represent 32% of the genome numerically, it reflects a substantial fraction of expressed genes undergoing major regulation. This stage represents a broad reorganization of cellular identity. Mature biofilm cells exhibit transcriptional programs optimized for structural integrity, oxidative stress tolerance, and long-term survival. The large number of upregulated genes likely contributes to extracellular matrix (ECM) production and reinforcement of the floating mat structure [^17][^18]. 

In contrast, the Mature vs Thin transition involves 1,127 DEGs (661 upregulated, 466 downregulated) but exhibits fewer extreme statistical outliers ([Figure 7](results/volcano_mvt.jpeg)). This pattern suggests that once the biofilm program is established in the Thin stage, maturation mainly involves fine-tuning rather than complete reorganization. Other biofilm-forming organisms  show similar patterns, such as _Candida albicans_ and _Pseudomonas aeruginosa_, where late-stage development stabilizes transcriptional programs rather than dramatically redefining them [^2].

Moreover, functional enrichment analysis further clarifies the biological mechanisms underlying these shifts. During Thin vs Early, oxoacid and organic acid metabolic processes were strongly enriched. These pathways allow yeast to shift from fermentative growth to utilization of non-preferred carbon sources such as ethanol and acetate, which accumulate during stationary growth. Such metabolic flexibility is essential for biofilm initiation at the air–liquid interface [^16][^17]. The strong upregulation of CYS3, involved in sulfur amino acid biosynthesis, suggests increased demand for cysteine and glutathione, key components in oxidative stress protection. Oxidative gradients are characteristic of floating biofilms, and enhanced sulfur metabolism has been linked to stress adaptation in structured yeast communities [^19].

During maturation, transmembrane transport processes were significantly enriched ([Figure 9](results/GO_mve.jpeg)). As the velum thickens, nutrient and oxygen diffusion become more limited, requiring improved transport systems to maintain cellular homeostasis [^18]. The observed downregulation of COX1 suggests possible metabolic stratification within the biofilm. Studies of structured yeast colonies have shown that inner cells can reduce respiratory activity while remaining viable [^20]. This supports the idea that mature biofilms contain metabolically specialized layers, with outer cells remaining active and inner cells conserving energy [^22].

Energy-related processes, including generation of precursor metabolites and energy and energy derivation by oxidation of organic compounds, were also significantly enriched in mature transitions. This indicates continued modulation of energy homeostasis beyond initial attachment. Structured yeast communities are known to undergo cyclical metabolic adaptation to balance redox state and resource allocation during long-term survival [^20][^23], supporting the idea that metabolic regulation remains dynamic even in established velum structures.

The non-linear expression pattern of BDH1 further highlights metabolic complexity during maturation. BDH1 encodes a 2,3-butanediol dehydrogenase involved in redox balancing and carbon overflow metabolism [^25]. Its decreased expression during Thin followed by reactivation in Mature suggests stage-specific metabolic roles. Volatile compounds such as 2,3-butanediol have been implicated in community-level signaling and stress adaptation in microbial biofilms [^24]. This dynamic regulation may reflect shifts between rapid metabolic remodeling during initiation and redox stabilization during mature biofilm maintenance.

Overall, these results show that velum formation is a coordinated developmental program. Early biofilm formation involves rapid metabolic and structural reorganization. Maturation then brings large-scale transcriptional divergence from planktonic cells, followed by targeted refinement of transport and energy processes. Rather than representing a simple slowdown of growth, velum development reflects a regulated transition toward a structured, metabolically specialized community optimized for long-term survival.
